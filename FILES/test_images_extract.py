...
SOURCE = os.path.join(PATH,'testSets')
...
def doc_to_docx():
    ...
    for i in converted_files:
        subprocess.call(['mv',i,'testUseCase1'])

source_new = os.path.join(PATH,'testSets')
print(source_new)
    ...
    for root, dirs, filenames in os.walk(SOURCE):
        ...
        for f in filenames:
            ...
            try:
                ...
                directory = os.path.join(PATH, "test_images2/%s" % filename)
                
                if not os.path.exists(directory):
                    os.makedirs(directory)
                print('trying to kklklkl extract images')
